...
public class TestForestFastjson2Converter extends JSONConverter {
    ...
    public void testSerializerFeature() {
        ...
        forestFastjsonConverter.setSerializerFeatureName(JSONWriter.Feature.WriteClassName.name());
        assertEquals(JSONWriter.Feature.WriteClassName.name(),
                forestFastjsonConverter.getSerializerFeatureName());
        assertEquals(JSONWriter.Feature.WriteClassName,
                forestFastjsonConverter.getSerializerFeature());

        forestFastjsonConverter.setSerializerFeature(JSONWriter.Feature.BeanToArray);
        assertEquals(JSONWriter.Feature.BeanToArray.name(),
                forestFastjsonConverter.getSerializerFeatureName());
        assertEquals(JSONWriter.Feature.BeanToArray,
                forestFastjsonConverter.getSerializerFeature());
    }
    ...
    public void testConvertToMap() {
        ...
        testObj.setId(1);
        testObj.setBody("xxx");
        testObj.setCrc(Byte.parseByte("1"));
        testObj.setDirection(4);
        testObj.setType("yyy");
        ForestFastjson2Converter forestFastjsonConverter = new ForestFastjson2Converter();
        Map<String, Object> map = forestFastjsonConverter.convertObjectToMap(testObj);
        assertEquals("{\"id\":1,\"direction\":4,\"type\":\"yyy\",\"body\":\"xxx\",\"crc\":1}", JSON.toJSONString(map, JSONWriter.Feature.ReferenceDetection));
    }
