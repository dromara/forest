 ...
 *
 *          <pre class="code">
 *          void send(&#064;XMLBody("username") String username, &#064;XMLBody("password") String password);
 *          </pre>
 *
 *          此模式的&#064;XMLBody注解可以修饰一个或多个参数，每个参数仅作为一个键值对。这些键值对最终会被合并成一个XML对象。<br><br>
 *
 *    （2） 对象模式：<br><br>
 *
 *          <pre class="code">
 ...
 *
 *          <pre class="code">
 *          void send(&#064;XMLBody Map paramMap);
 *          </pre>
 *
 *          此模式的&#064;XMLBody注解可以修饰一个或多个Map对象，但不能设置名称（value属性）以表明它不是一个键值对。被修饰的参数对象会被拆成一个个键值对（Map中的所有有值的键值对），
 *          所有这些键值对被合并成一个XML对象。<br><br>
 *
 *    （4） 字符串模式：<br><br>
 *
 *          <pre class="code">
