...
最新版本为<font color=red>1.4.8</font>，为稳定版本

如果您用的是Gradle:

```gradle
compile group: 'com.dtflys.forest', name: 'spring-boot-starter-forest', version: '1.4.8'
```
...
```gradle
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.4.8'
```
