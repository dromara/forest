...
最新版本为<font color=red>1.4.2</font>，为正式版本

如果您用的是Gradle:

```gradle
compile group: 'com.dtflys.forest', name: 'spring-boot-starter-forest', version: '1.4.2'
```
...
最新版本为<font color=red>1.4.2</font>，为稳定版本

如果您用的是Gradle:

```gradle
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.4.2'
```
...
Forest从1.4.2版本开始支持多种形式的文件上传和文件下载功能
