...
最新版本为<font color=red>1.5.0-BETA4</font>，为稳定版本

如果您用的是Gradle:

```gradle
compile group: 'com.dtflys.forest', name: 'spring-boot-starter-forest', version: '1.5.0-BETA4'
```
...
最新版本为<font color=red>1.5.0-BETA4</font>

如果您用的是Gradle:

```gradle
compile group: 'com.dtflys.forest', name: 'forest-core', version: '1.5.0-BETA4'
```
