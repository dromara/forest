/*
package org.dromara.spring.test;

import org.dromara.forest.config.ForestConfiguration;
import org.dromara.forest.proxy.ForestClientProxy;
import org.dromara.spring.test.client0.BeastshopClient;
import org.dromara.spring.test.client1.BaiduClient;
import org.dromara.spring.test.client2.GithubClient;
...
//        assertNotNull(bean);
    ...
    @Configuration
//    @ForestScan(basePackages = "org.dromara.spring.test.client0")
    static class BootConfig0 {
    }


    @Configuration
//    @ForestScan(basePackages = "org.dromara.spring.test.client1")
    ...
    @Configuration
//    @ForestScan(basePackages = "org.dromara.spring.test.client2", configuration = "cnf1")
