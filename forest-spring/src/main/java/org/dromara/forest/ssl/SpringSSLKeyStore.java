    ...
    private static SSLSocketFactoryBuilder getSSLSocketFactoryBuilder(String sslSocketFactoryBuilderClass) {
        ...
        try {
            ...
            if (!SSLSocketFactoryBuilder.class.isAssignableFrom(clazz)) {
                throw new ForestRuntimeException("[Forest] The value of property 'sslSocketFactoryBuilder' must be a class inherited from org.dromara.forest.ssl.SSLSocketFactoryBuilder");
            }
