...
import org.dromara.forest.ssl.SpringSSLKeyStore;
                    ...
                    if ("backend".equals(attributeName)) {
                        ...
                        try {
                            ...
                            if (!ForestLogHandler.class.isAssignableFrom(clazz)) {
                                throw new ForestRuntimeException("property 'logHandler' must be a class extending from org.dromara.forest.logging.ForestLogHandler");
                            }
