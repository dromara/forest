...
public class TestForestJacksonConverter extends JSONConverter {
    ...
    @Test
    public void testJavaObjectToMap3() throws JsonProcessingException {
        ...
        assertEquals(objectMapper.writeValueAsString(causes),
                objectMapper.writeValueAsString(map.get("cause")));
    }
