package org.dromara.forest.core.test.exception;
...
public class TestExceptions {
    ...
    public void testInterceptorDefineException() {
        ...
        assertThat(exception.getMessage())
                .isEqualTo("[Forest] Interceptor class 'org.dromara.forest.core.test.exception.TestExceptions$TestErrorInterceptor' cannot be initialized, because interceptor class must implements org.dromara.forest.interceptor.Interceptor");
    ...
    public void testVariableUndefinedException2() {
        ...
        assertThat(exception.getMessage()).isEqualTo("[Forest] Cannot resolve variable 'data'\n" +
                "\n" +
                "\t[From Template]\n" +
                "\tmethod: org.dromara.forest.core.test.exception.TestExceptions$TestClient.urlVar()\n" +
    ...
    public void testVariableUndefinedException3() {
        ...
        assertThat(exception.getMessage()).isEqualTo("[Forest] Cannot resolve variable 'json'\n" +
                "\n" +
                "\t[From Template]\n" +
                "\tmethod: org.dromara.forest.core.test.exception.TestExceptions$TestClient.contentTypeVar()\n" +
                "\tannotation: org.dromara.forest.annotation.@Get\n" +
    ...
    public void testVariableUndefinedException_file() {
        ...
        assertThat(exception.getMessage()).isEqualTo("[Forest] Cannot resolve variable 'filename'\n" +
                "\n" +
                "\t[From Template]\n" +
                "\tmethod: org.dromara.forest.core.test.exception.TestExceptions$TestClient.fileVar(java.lang.String)\n" +
