package org.dromara.forest.example.solon.controller;
...
public class TestDownloadController {
    ...
    @Get
    @Mapping("/download-image-to-byte-array")
    ...
    @Get
    @Mapping("/download-image-to-byte-array-with-annotation")
    ...
    @Get
    @Mapping("/download-image-to-stream")
